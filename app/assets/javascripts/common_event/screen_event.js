...
ScreenEvent = (function(superClass) {
  ...
  ScreenEvent.PrivateClass = (function(superClass1) {
    ...
    PrivateClass.prototype.changeScreenPosition = function(e, complete) {
    ...
    PrivateClass.prototype.clearPaging = function(methodName) {
      PrivateClass.__super__.clearPaging.call(this, methodName);
