...
var addStorage, availJs, changeGradientShow, changeMode, clearAllItemStyle, clearWorkTable, closeSidebar, createColorPicker, drawItemFromStorage, flushWarn, getInitFuncName, getObjFromObjectListByElementId, getStorageByKey, initColorPickerValue, initCommonVar, initHandwrite, initHeaderMenu, initKeyEvent, loadFromServer, loadItemJs, openConfigSidebar, popOperationHistory, popOperationHistoryRedo, pushOperationHistory, redo, run, runLookAround, saveToServer, settingColorPicker, settingGradientDegSlider, settingGradientSlider, settingGradientSliderByElement, settingSlider, setupContextMenu, setupEvents, setupTimeLineCss, setupTimeLineObjects, showError, showWarn, switchGradientColorSelectorVisible, undo;
...
openConfigSidebar = function(scrollLeft) {
  if (scrollLeft == null) {
    scrollLeft = null;
  }
