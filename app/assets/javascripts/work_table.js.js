...
var addStorage, availJs, changeGradientShow, changeMode, clearAllItemStyle, clearSelectedBorder, clearWorkTable, closeSidebar, createColorPicker, drawItemFromStorage, flushWarn, focusToTarget, getInitFuncName, getObjFromObjectListByElementId, getStorageByKey, initColorPickerValue, initCommonVar, initHandwrite, initHeaderMenu, initKeyEvent, isClosedConfigSidebar, isOpenedConfigSidebar, loadFromServer, loadItemJs, openConfigSidebar, popOperationHistory, popOperationHistoryRedo, pushOperationHistory, redo, run, runLookAround, saveToServer, setSelectedBorder, settingColorPicker, settingGradientDegSlider, settingGradientSlider, settingGradientSliderByElement, settingSlider, setupContextMenu, setupEvents, setupTimeLineCss, setupTimeLineObjects, setupTimelineEvents, showError, showWarn, switchGradientColorSelectorVisible, undo;
