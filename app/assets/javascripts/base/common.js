...
var _getPageValue, _setPageValue, checkBlowserEnvironment, focusToTarget, generateId, getClassFromMap, getPageValue, getTimelinePageValue, makeClone, removePageValue, sanitaizeDecode, sanitaizeEncode, setClassToMap, setPageValue, setTimelinePageValue, typeOfValue;
...
getClassFromMap = function(isCommon, id) {
  ...
  if ((window.classMap == null) || (window.classMap[c] == null) || (window.classMap[c][i] == null)) {
    return null;
  }
