...
setupTimelineEvents = function() {
  ...
  return $('.timeline_event').droppable({
    ...
    drop: function(event, ui) {
      return console.log("drop event:" + event + " ui:" + ui);
    }
  });
};
...
dragDropTimelineEvents = function() {};
