...
const vendors = [
  ...
  path.join(railsRootPath, '/vendor/assets/masonry/masonry.pkgd.min.js'),
...
const jsFiles = [
  ...
  path.join(railsRootPath, '/frontend/src/my_page/my_page_common.js'),
  path.join(railsRootPath, '/frontend/src/my_page/my_page.js')
];
module.exports = {
  entry: {
