...
const vendors = [
  ...
  path.join(railsRootPath, '/vendor/assets/html2canvas/html2canvas_custom.min.js')
];
const jsFiles = [
  ...
  path.join(railsRootPath, '/frontend/src/upload/upload_base.js'),
  path.join(railsRootPath, '/frontend/src/upload/upload_contents.js'),
  path.join(railsRootPath, '/frontend/src/upload/upload_item.js'),
  path.join(railsRootPath, '/frontend/src/upload/upload_common.js'),
  path.join(railsRootPath, '/frontend/src/upload/upload.js')
];
module.exports = {
  entry: {
