...
export const createImage = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/item_image/create_img`, {method: 'POST', body: data}).then(
    response => response.json(),
    error => console.log('An error occurred in createImage.', error)
  ).then(json => dispatch({type: 'CREATE_IMAGE', json}));

export const removeWorktableProjectImage = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/item_image/remove_worktable_project_img`, {method: 'POST', body: data}).then(
    response => response.json(),
...
export const removeWorktableItemImage = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/item_image/remove_worktable_item_image`, {method: 'POST', body: data}).then(
    response => response.json(),
...
export const removeGalleryImage = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/item_image/remove_gallery_image`, {method: 'POST', body: data}).then(
    response => response.json(),
