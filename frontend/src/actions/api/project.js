...
export const createProject = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/project/create`, {method: 'POST', body: data}).then(
...
export const getProject = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/project/get_project_by_user_pagevalue_id`, {method: 'POST', body: data}).then(
    response => response.json(),
    error => console.log('An error occurred in getProject.', error)
  ).then(json => dispatch({type: 'GET_PROJECT', json}));

export const getAdminMenu = () => (dispatch) =>
...
export const updateProject = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/project/update`, {method: 'POST', body: data}).then(
    response => response.json(),
    error => console.log('An error occurred in updateProject.', error)
  ).then(json => dispatch({type: 'UPDATE_PROJECT', json}));

export const resetProject = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/project/reset`, {method: 'POST', body: data}).then(
    response => response.json(),
    error => console.log('An error occurred in resetProject.', error)
  ).then(json => dispatch({type: 'RESET_PROJECT', json}));

export const removeProject = (data) => (dispatch) =>
  fetch(`${window.apiUrl}/project/remove`, {method: 'POST', body: data}).then(
    response => response.json(),
