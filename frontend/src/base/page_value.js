...
var PageValue = (function() {
  ...
  let _getPageValue = undefined;
  let _getPageValueDebug = undefined;
  let _getPageValueProduction = undefined;
  let _setPageValue = undefined;
  let _setPageValueDebug = undefined;
  let _setPageValueProduction = undefined;
  PageValue = class PageValue {
    static initClass() {
      // 定数
      constant = gon.const;
      // ページ内値保存キー
