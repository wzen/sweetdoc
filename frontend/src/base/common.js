...
export default class Common {
  static initClass() {
    ...
    let _showModalFlashMessage = function (message, isModalFlush = false, immediately = true, enableOverlayClose = false) {
    ...
    let _showModalView = function (type, prepareShowFunc, prepareShowFuncParams, isModalFlush, showFunc = null) {
