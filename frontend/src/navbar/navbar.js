...
import ItemStateConfig from '../sidebar_config/item_state_config';
import ItemPreviewCommon from '../item_preview/item_preview_common';
import CodingCommon from '../coding/coding_common';
import RunCommon from '../run/common/run_common';
import RunSetting from '../run/common/run_setting';
import ServerStorage from '../worktable/common/server_storage';
import WorktableSetting from '../worktable/common/worktable_setting';
...
export default class Navbar {
  ...
  static initWorktableNavbar() {
    ...
    $('.menu-item', itemsSelectMenuEmt).off('click').on('click', function(e) {
      ...
      if(emtId.indexOf(Navbar.ITEM_MENU_PREFIX) >= 0) {
        ...
        return Navbar.setModeDraw(classDistToken, () => {
  ...
  static initCodingNavbar() {
    ...
    return menuSave.off('click').on('click', () => CodingCommon.saveAllCode());
  }
  ...
  static initItemPreviewNavbar() {
    ...
    return $('.menu-add-item', navEmt).off('click').on('click', () => ItemPreviewCommon.showAddItemConfirm());
  }
